 ...
 */
really_inline size_t process_block_branchless(const BranchlessStateMachine& sm, const uint8_t* buf,
                                              size_t len, BranchlessState& state, uint64_t* indexes,
                                              uint64_t base, size_t& idx, size_t stride) {
  size_t count = 0;
 ...
 * @return Number of field separators found
 */
inline uint64_t second_pass_branchless(const BranchlessStateMachine& sm, const uint8_t* buf,
 ...
 */
inline void get_error_line_column(const uint8_t* buf, size_t buf_len, size_t offset, size_t& line,
                                  size_t& column) {
  line = 1;
  column = 1;
 ...
 * @return Number of field separators found
 */
inline uint64_t second_pass_branchless_with_errors(const BranchlessStateMachine& sm,
